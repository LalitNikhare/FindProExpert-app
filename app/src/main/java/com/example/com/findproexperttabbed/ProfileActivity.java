...
public class ProfileActivity extends AppCompatActivity {
    ...
    TextView user_eff,user_profile_name, text_view_mobno, text_view_email, text_view_skills, user_profile_username;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_eff= (TextView) findViewById(R.id.eff);
    ...
    private void setDetails(String response) {
        ...
        user_eff.setText("Efficiency : "+JSONProfessional.job_done+"/"+JSONProfessional.job_accepted+" jobs done");
